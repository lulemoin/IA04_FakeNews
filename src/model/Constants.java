...
public class Constants {
	...
	public static Integer NOMBRE_INDIVIDUS = 500;

	public static String DEFAULT_DEMANDEUR_AGENT = "Demandeur";
	
	public static int MOYENNE_NB_CONNEXION = 150*NOMBRE_INDIVIDUS/3000;
	public static int ECART_TYPE_NB_CONNEXION = 50*NOMBRE_INDIVIDUS/3000;
